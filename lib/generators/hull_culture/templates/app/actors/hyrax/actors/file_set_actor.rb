...
module Hyrax
  module Actors
    ...
    class FileSetActor
      ...
      # Moved the ordered_members into a OrderedMembersActor, so
      #   don't add to ordered_members, and don't reload or save
      def attach_to_work(work, file_set_params = {})
        acquire_lock_for(work.id) do
          ...
          work.representative = file_set if work.representative_id.blank? || (file_set.label == "0001.tif")
          work.thumbnail = file_set if work.thumbnail_id.blank? || (file_set.label == "0001.tif")
